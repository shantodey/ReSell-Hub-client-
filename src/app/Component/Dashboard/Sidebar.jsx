...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        { id: 'Add Product', label: 'Add Product', icon: <FiShoppingBag className="text-lg" />, path: '/dashboard/seller' },
        { id: 'My Products', label: 'My Products', icon: <FiShoppingBag className="text-lg" />, path: '/dashboard/seller' },
        { id: 'Manage Orders', label: 'Manage Orders', icon: <FiHeart className="text-lg" />, path: '/dashboard/seller' },
        { id: 'Sales Analytics', label: 'Sales Analytics', icon: <FiCreditCard className="text-lg" />, path: '/dashboard/seller' },
        { id: 'Profile Management', label: 'Profile Management', icon: <FiUser className="text-lg" />, path: '/dashboard/seller' },
    ];
    ...
    //     // অপশনাল ফিচার (Product Reporting System) এর জন্য মেনু
